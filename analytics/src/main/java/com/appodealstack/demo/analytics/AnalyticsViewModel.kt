...
import com.android.billingclient.api.QueryProductDetailsParams.newBuilder
...
class AnalyticsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val purchasesUpdatedListener = PurchasesUpdatedListener { billingResult, purchases ->
        ...
        when (billingResult.responseCode) {
            ...
            BillingResponseCode.USER_CANCELED -> debug("onPurchasesUpdated: User canceled the purchase")
            BillingResponseCode.ITEM_ALREADY_OWNED -> debug("onPurchasesUpdated: The user already owns this item")
